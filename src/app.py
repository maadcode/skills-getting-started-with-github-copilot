...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice, technique, and lifeguard skills",
    ...
    "Drama Society": {
        "description": "Acting, directing, and stagecraft; seasonal productions",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 30,
        "participants": ["emma.l@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice public speaking and competitive debating",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["zara@mergington.edu", "noor@mergington.edu"]
    },
    "Robotics Club": {
